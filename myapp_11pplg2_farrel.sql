...
--
-- Host: 127.0.0.1
-- Generation Time: Oct 19, 2023 at 02:28 AM
...
CREATE TABLE `hero` (
  ...
  `status` varchar(50) CHARACTER SET utf32 COLLATE utf32_general_ci NOT NULL
...
('1', 'farrelputra', 'admin', 'd033e22ae348aeb5660fc2140aec35850c4da997', 'admin');
